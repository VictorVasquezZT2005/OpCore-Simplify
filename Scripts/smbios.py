...
class SMBIOS:
    ...
    def select_smbios_model(self, hardware_report, macos_version):
        ...
        if platform != "Laptop" and hardware_report.get("GPU") and list(hardware_report.get("GPU").items())[-1][-1].get("Device Type") != "Integrated GPU":
            return smbios_model
        ...
        if codename in ("Arrandale", "Clarksfield"):
            ...
            if "Desktop" in platform:
                smbios_model = "iMac13,1" if hardware_report.get("GPU") and "Integrated GPU" in list(hardware_report.get("GPU").items())[0][-1].get("Device Type") else "iMac13,2"
            elif "NUC" in platform:
            ...
            if "Desktop" in platform:
                smbios_model = "iMac14,4" if hardware_report.get("GPU") and "Integrated GPU" in list(hardware_report.get("GPU").items())[0][-1].get("Device Type") else "iMac15,1"
            elif "NUC" in platform:
            ...
            if "Desktop" in platform:
                smbios_model = "iMac16,2" if hardware_report.get("GPU") and "Integrated GPU" in list(hardware_report.get("GPU").items())[0][-1].get("Device Type") else "iMac17,1"
            elif "NUC" in platform:
            ...
            smbios_model = "iMac18,1" if hardware_report.get("GPU") and "Integrated GPU" in list(hardware_report.get("GPU").items())[0][-1].get("Device Type") else "iMac18,3"
            if "Laptop" in platform:
